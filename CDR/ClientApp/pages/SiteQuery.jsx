...
class SiteQuery extends React.Component 
{
    ...
    componentDidMount()
    {
        ...
        let sitesLoaded = true;
        if (!sites || sites.length < 1) sitesLoaded = false;
        this.setState({ sites: sites, sitesLoaded: sitesLoaded });
    }
    ...
    render()
    {
        const { confirmLoading, searchObj, sites, viralLoads, txNew, sitesLoaded } = this.state;
        ...
        return (
            <div className="site-top">
                <Helmet>
                    <title>CDR - Site Performances</title>
                </Helmet>
                <div className="custom-filter-dropdown">
                    <br />
                    <Row style={{ marginTop: '2px' }}>
                        <Col span={24}>
                            <h4 style={{ fontWeight: 'bold', fontSize: '18px' }}>Site Performances</h4>
                        </Col>
                    </Row>
                    <br />
                    <Row gutter={2}>
